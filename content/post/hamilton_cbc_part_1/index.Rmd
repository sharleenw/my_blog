...
I've noticed birders will say things like, "the House Sparrows are getting worse every year" or, "the number of Bald Eagles has increased", and I was wondering if the Christmas Bird Count data would agree or disagree with those statements.
...
The first three tables contain count day weather data. A lot of the weather data is missing and possibly inconsistent. I will remove these three tables from the bird count data table.

In order to get an idea of what I mean, here are glimpses of the data between the tables.
...
I won't show the data of the fifth table here, but it shows the full names of the counters. I won't add this data to `overall_meta_table`, so I will just remove the table from the dataset.
