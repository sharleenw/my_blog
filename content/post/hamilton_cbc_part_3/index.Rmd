...
Here is the link to my Shiny app, and below, I posted the code I used to make the app.
...
```{r shiny, code = readLines(here("content", "post", "hamilton_cbc_part_3", "shiny_app", "app.R")), message = FALSE, warning = FALSE, eval = FALSE}
