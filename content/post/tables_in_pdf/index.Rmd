...
I used the website [Convert Wiki Tables to CSV](https://wikitable2csv.ggor.de/) to turn the table on the Wikipedia page into a CSV file.
...
The document :sparkles::tada:[Create Awesome LaTeX Table with knitr::kable andkableExtra](https://haozhu233.github.io/kableExtra/awesome_table_in_pdf.pdf):tada::sparkles:, written by Hao Zhu! It's got everything you need in order to make fantastic tables in PDF using RMarkdown.

To see the final PDF output of the below `.Rmd` file, download it [here](https://github.com/sharleenw/my_blog/blob/master/content/post/tables_in_pdf/largest_canadian_cities.pdf)!
